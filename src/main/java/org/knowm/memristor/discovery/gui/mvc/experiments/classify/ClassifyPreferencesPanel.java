...
public class ClassifyPreferencesPanel extends ExperimentPreferencesPanel {
    ...
    this.seriesResistorTextField.setText(
        String.valueOf(
            experimentPreferences.getInteger(
                ClassifyPreferences.SERIES_R_INIT_KEY,
  ...
  public void doSavePreferences() {
    ...
    experimentPreferences.setInteger(
        ClassifyPreferences.SERIES_R_INIT_KEY, Integer.parseInt(seriesResistorTextField.getText()));
    experimentPreferences.setFloat(
        ClassifyPreferences.AMPLITUDE_INIT_FLOAT_KEY,
        Float.parseFloat(amplitudeTextField.getText()));
    experimentPreferences.setInteger(
        ClassifyPreferences.PULSE_WIDTH_INIT_KEY, Integer.parseInt(pulseWidthTextField.getText()));
    experimentPreferences.setInteger(
        ClassifyPreferences.NUM_TRAIN_EPOCHS_INIT_KEY,
