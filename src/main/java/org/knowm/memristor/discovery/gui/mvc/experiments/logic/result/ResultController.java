...
public class ResultController {
  ...
  public void resetChart() {
    ...
    Set<String> seriesNames = resultPanel.chart.getSeriesMap().keySet();
    ...
    for (int i = 0; i < toDelete.size(); i++) {
      resultPanel.chart.removeSeries(toDelete.get(i));
    }
  ...
  public void addFFRATrace(List<TraceDatum> trace) {
    ...
    int traceNum = resultModel.getNumTraces();
    ...
    XYSeries series2 = resultPanel.chart.addSeries(traceNum + "_2", vy_a, vy_b);
    series2.setMarker(SeriesMarkers.NONE);
    series2.setLineColor(Color.gray);
    series2.setLineWidth(.2f);

    resultModel.addTrace(trace);
    repaintChart();
  }
  ...
  public void repaintChart() {
    ...
    resultPanel.getChartPanel().revalidate();
    resultPanel.getChartPanel().repaint();
  }
}
