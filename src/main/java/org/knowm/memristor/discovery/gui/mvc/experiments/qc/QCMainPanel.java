...
public class QCMainPanel extends JPanel {
  ...
  public QCMainPanel() {
    ...
    ivChart =
        new XYChartBuilder()
            ...
            .yAxisTitle("Current [" + QCPreferences.CURRENT_UNIT_DEFAULT_VALUE.getLabel() + "]")
            .build();
  ...
  public void udpateWaveformChart(
      double[] waveformTimeData, double[] waveformAmplitudeData, double amplitude, int frequency) {
