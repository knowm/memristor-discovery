...
public class ControlController extends Controller {
  ...
  public void doSetUpViewEvents() {
    ...
    controlPanel.getSelectFileButton().addActionListener(new ActionListener() {

      @Override
      public void actionPerformed(ActionEvent e) {

        try {
          String filePath = FileUtils.showPickFileDialog(controlPanel, controlModel.getFilePath(), ControlController.getSATFileFilter());
