...
public class AHaHController_12 {
  ...
  private void execute(Instruction12 instruction) {
    ...
    // System.out.println("switches should be off: " + Integer.toBinaryString(dWFProxy.getDigitalIOStates()));
    ...
    // System.out.println("A and B switches should be on: " + Integer.toBinaryString(dWFProxy.getDigitalIOStates()));
    ...
    // System.out.println("Before Instruction " + Integer.toBinaryString(dWFProxy.getDigitalIOStates()));
    ...
    //System.out.println("After Instruction " + Integer.toBinaryString(dWFProxy.getDigitalIOStates()));
    dWFProxy.turnOffAllSwitches(2);
    /*
