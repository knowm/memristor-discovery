...
public class RightBarController implements PropertyChangeListener {
  ...
  private void setUpViewEvents() {
    ...
    rightBarPanel
        .getOscilloscopeProbe10RadioButton()
        .addActionListener(
            new ActionListener() {
              @Override
    ...
    rightBarPanel
        .getOscilloscopeProbe1ARadioButton()
        .addActionListener(
            new ActionListener() {
              @Override
              public void actionPerformed(ActionEvent e) {
    ...
    rightBarPanel
        .getOscilloscopeProbe1BRadioButton()
        .addActionListener(
            new ActionListener() {
              @Override
              public void actionPerformed(ActionEvent e) {
    ...
    rightBarPanel
        .getOscilloscopeProbe1YRadioButton()
        .addActionListener(
            new ActionListener() {
              @Override
              public void actionPerformed(ActionEvent e) {
    ...
    rightBarPanel
        .getOscilloscopeProbe20RadioButton()
        .addActionListener(
            new ActionListener() {
              @Override
              public void actionPerformed(ActionEvent e) {
    ...
    rightBarPanel
        .getOscilloscopeProbe2ARadioButton()
        .addActionListener(
            new ActionListener() {
              @Override
              public void actionPerformed(ActionEvent e) {
    ...
    rightBarPanel
        .getOscilloscopeProbe2BRadioButton()
        .addActionListener(
            new ActionListener() {
              @Override
              public void actionPerformed(ActionEvent e) {
    ...
    rightBarPanel
        .getOscilloscopeProbe2YRadioButton()
        .addActionListener(
            new ActionListener() {
              @Override
              public void actionPerformed(ActionEvent e) {
