...
public class QCController implements PropertyChangeListener {
   ...
   */
  public QCController(
      QCControlPanel controlPanel, QCMainPanel mainPanel, QCControlModel model, DWFProxy dwf) {
    ...
    mainPanel.udpateWaveformChart(
        model.getWaveformTimeData(),
        model.getWaveformAmplitudeData(),
        model.getAmplitude(),
        model.getFrequency());
  }
