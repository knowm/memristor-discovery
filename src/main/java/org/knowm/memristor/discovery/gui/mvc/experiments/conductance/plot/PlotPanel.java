...
public class PlotPanel extends ExperimentPlotPanel {
  ...
  public PlotPanel() {
    ...
    ivChart = new XYChartBuilder().width(600).title("I-T").height(400).yAxisTitle("Current [" + ConductancePreferences.CURRENT_UNIT.getLabel() + "]").xAxisTitle("Voltage [V]").build();
    ...
    gvChart = new XYChartBuilder().width(100).title("G-T").height(100).yAxisTitle("Conductance [" + ConductancePreferences.CONDUCTANCE_UNIT.getLabel() + "]").xAxisTitle("Voltage [V]").build();
