...
public class PulseApp extends App implements PropertyChangeListener {
  ...
  private class CaptureWorker extends SwingWorker<Boolean, double[][]> {
    ...
    protected Boolean doInBackground() throws Exception {
      ...
      double[] customWaveform = WaveformUtils.generateCustomWaveform(Waveform.HalfSine, experimentModel.getAppliedAmplitude(), experimentModel.getCalculatedFrequency());
