...
public class V1BoardCheckPreferencesPanel extends ExperimentPreferencesPanel {
   ...
   * @param owner
   */
  public V1BoardCheckPreferencesPanel(JFrame owner) {
  ...
  public void doCreateAndShowGUI(JPanel preferencesPanel) {
    ...
    this.seriesResistorTextField.setText(String.valueOf(experimentPreferences.getInteger(V1BoardCheckPreferences.SERIES_R_INIT_KEY, V1BoardCheckPreferences.SERIES_R_INIT_DEFAULT_VALUE)));
    ...
    this.amplitudeTextField.setText(String.valueOf(experimentPreferences.getFloat(V1BoardCheckPreferences.AMPLITUDE_INIT_FLOAT_KEY, V1BoardCheckPreferences.AMPLITUDE_INIT_FLOAT_DEFAULT_VALUE)));
    ...
    this.pulseWidthTextField.setText(String.valueOf(experimentPreferences.getInteger(V1BoardCheckPreferences.PULSE_WIDTH_INIT_KEY, V1BoardCheckPreferences.PULSE_WIDTH_INIT_DEFAULT_VALUE)));
    ...
    this.sampleRateTextField.setText(String.valueOf(experimentPreferences.getInteger(V1BoardCheckPreferences.SAMPLE_RATE_INIT_KEY, V1BoardCheckPreferences
  ...
  public void doSavePreferences() {
    ...
    experimentPreferences.setInteger(V1BoardCheckPreferences.SERIES_R_INIT_KEY, Integer.parseInt(seriesResistorTextField.getText()));
    experimentPreferences.setFloat(V1BoardCheckPreferences.AMPLITUDE_INIT_FLOAT_KEY, Float.parseFloat(amplitudeTextField.getText()));
    experimentPreferences.setInteger(V1BoardCheckPreferences.PULSE_WIDTH_INIT_KEY, Integer.parseInt(pulseWidthTextField.getText()));
    experimentPreferences.setInteger(V1BoardCheckPreferences.SAMPLE_RATE_INIT_KEY, Integer.parseInt(sampleRateTextField.getText()));
  }

  @Override
  public ExperimentPreferences initAppPreferences() {

    return new V1BoardCheckPreferences();
  }
