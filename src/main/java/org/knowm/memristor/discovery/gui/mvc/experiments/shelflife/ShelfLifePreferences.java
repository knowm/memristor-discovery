...
public class ShelfLifePreferences extends ExperimentPreferences {
  ...
  public static final float READ_VOLTS_DEFAULT_VALUE = .08f;
  ...
  public static final int READ_PULSE_WIDTH_DEFAULT_VALUE = 50;

  public static final String WRITE_PULSE_WIDTH_INIT_KEY = PREFIX + "WRITE_PULSE_WIDTH_INIT_KEY";
  public static final int WRITE_PULSE_WIDTH_DEFAULT_VALUE = 50;

  public static final String ERASE_PULSE_WIDTH_INIT_KEY = PREFIX + "ERASE_PULSE_WIDTH_INIT_KEY";
  public static final int ERASE_PULSE_WIDTH_DEFAULT_VALUE = 100;
  ...
  public static final String MIN_ERASE_RESISTANCE_INIT_KEY =
      PREFIX + "MIN_ERASE_RESISTANCE_INIT_KEY";
