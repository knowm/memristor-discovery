...
public class AboutHandlerInvocationHandler
    extends BaseMacInvocationHandler<GenericAboutHandler, GenericAboutEvent> {

  AboutHandlerInvocationHandler(
      GenericAboutHandler genericHandler, Class<GenericAboutEvent> genericEventClass) {
