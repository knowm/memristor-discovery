...
public class OpenURIHandlerInvocationHandler
    extends BaseMacInvocationHandler<GenericOpenURIHandler, GenericOpenURIEvent> {

  OpenURIHandlerInvocationHandler(
      GenericOpenURIHandler genericHandler, Class<GenericOpenURIEvent> genericEventClass) {
