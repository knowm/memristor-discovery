...
public class PreferencesHandlerInvocationHandler
    extends BaseMacInvocationHandler<GenericPreferencesHandler, GenericPreferencesEvent> {

  PreferencesHandlerInvocationHandler(
      GenericPreferencesHandler genericHandler, Class<GenericPreferencesEvent> genericEventClass) {
