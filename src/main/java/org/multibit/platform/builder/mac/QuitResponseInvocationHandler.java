...
public class QuitResponseInvocationHandler
    extends BaseMacInvocationHandler<GenericQuitHandler, GenericQuitResponse> {

  QuitResponseInvocationHandler(
      GenericQuitHandler genericHandler, Class<GenericQuitResponse> genericEventClass) {
