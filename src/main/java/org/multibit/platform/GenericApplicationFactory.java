...
/**
 * Factory to provide the following to application:
 *
 * <ul>
 *   <li>Builds a {@link GenericApplication} appropriate for the execution platform
 * </ul>
 *
 * @since 0.2.0
 */
public enum GenericApplicationFactory {
   ...
   */
  public synchronized GenericApplication buildGenericApplication(
      GenericApplicationSpecification specification) {
