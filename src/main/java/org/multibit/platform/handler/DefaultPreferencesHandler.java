 ...
 * @since 0.3.0
 */
public class DefaultPreferencesHandler
    implements GenericPreferencesHandler, GenericEventListener<GenericPreferencesEventListener> {
  private static final Logger log = LoggerFactory.getLogger(DefaultPreferencesHandler.class);

  // The event listeners
  private Set<GenericPreferencesEventListener> listeners =
